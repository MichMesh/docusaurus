...
- Repeater: Use this if you have a great location (greater than 500ft HAAT), don't a screen, and need prioritized routing. These are AND statements, if one doesn't apply to you, don't use this role. This role will not show up in your node lists.
- Router_Late: Use this if you have an OK location (100-500ft HAAT), and need prioritized routing. These are AND statements, if one doesn't apply to you, don't use this role.
