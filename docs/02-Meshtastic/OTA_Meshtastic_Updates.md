...
---
# OTA Firmware Updates via the Meshtastic App

The Meshtastic app now includes **built-in firmware update support** for nRF52, ESP32, and USB DFU-compatible devices. You no longer need the separate Nordic DFU Utility or nRF Connect app.

---

## Before You Start

- Make sure your Meshtastic app is **v2.7.8 or newer** (check the Google Play or iOS Store for updates)
- Plug your phone in or ensure it has plenty of battery — updates can take several minutes
- Keep your phone **awake** during the update (on Android you can go to **Settings > Developer Options > Stay Awake** while charging)
...
import ImageRight from '@site/src/components/ImageRight';

<ImageRight src={require('../images/meshtastic-ios-upgrade-ss.jpg').default} alt="Meshtastic iOS OTA upgrade screenshot" width={250}>
...
The app will check for available firmware and guide you through the update process. Follow the on-screen prompts to download and flash the new firmware. **Note that the Alpha updates are inherently unstable. Use at your own risk!**
...
- **Update not appearing?** Make sure your Meshtastic app is up to date from the iOS / Play Store.
